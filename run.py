...
def get_last_5_entries_sales():
    ...
    # column = sales.col_values(3)  #columns in google sheet worksheet start at 1 not like python index 0.

    columns = []
    for ind in range(1, 7):
        column = sales.col_values(ind)
        columns.append(column[-5:]) #take/slice the last 5 lists (- does this) and use : , for multiple lists
    pprint(columns)
